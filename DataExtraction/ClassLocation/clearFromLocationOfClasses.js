...
var ReferenceObject = JSON.parse(fs.readFileSync('../Data/Processed/LocationsOfClasses.json', 'utf8'));
...
function saveFunction() {
    // all the stuff you want to happen after that pause
		...
		fs.writeFile("../Data/Processed/LocationsOfClasses.json", JSON.stringify(ReferenceObject), function(err) {
		    if(err) {
		        return console.log(err);
		    }else{
